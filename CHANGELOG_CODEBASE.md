...
| [`deepgen/scripts/export_adapter_weights.py`](file:///home/dsi/davidpo/projects/Semi/deepgen/scripts/export_adapter_weights.py) | Model Utilities & Export | Exports lightweight standalone adapter checkpoint (`deepgen_sft_llm_adapter_50k.pt`, ~80MB) from full training state and asserts parameter L1 norm integrity. |
